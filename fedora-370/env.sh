...
LAUNCHDIR=/usr/local/djatoka/bin
cd ..
...
#JAVA_OPTS="$JAVA_OPTS" "$DEBUG -Djava.awt.headless=true -Dkakadu.home=$KAKADU_HOME -Djava.library.path=$LIBPATH/$PLATFORM $KAKADU_LIBRARY_PATH"

#JAVA_OPTS="$DEBUG -Djava.awt.headless=true  -Xmx512M -Xms64M -XX:PermSize=128M -XX:MaxPermSize=512m -Dkakadu.home=$KAKADU_HOME -Djava.library.path=$LIBPATH/$PLATFORM $KAKADU_LIBRARY_PATH"
JAVA_OPTS="$JAVA_OPTS -Djava.awt.headless=true -Xmx512M -Xms64M -XX:PermSize=128M -XX:MaxPermSize=512m  -Dkakadu.home=$KAKADU_HOME -Djava.library.path=$LIBPATH/$PLATFORM $KAKADU_LIBRARY_PATH"
